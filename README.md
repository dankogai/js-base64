...
```html
<script src="https://cdn.jsdelivr.net/npm/js-base64@3.9.3/base64.min.js"></script>
```
...
import { Base64 } from 'https://cdn.jsdelivr.net/npm/js-base64@3.9.3/base64.mjs';
</script>
```
...
<script type="module">
// or if you prefer no Base64 namespace
import { encode, decode } from 'https://cdn.jsdelivr.net/npm/js-base64@3.9.3/base64.mjs';
</script>
```
