...
```html
<script src="https://cdn.jsdelivr.net/npm/js-base64@3.2.1/base64.min.js">
```
...
import { Base64 } from 'https://cdn.jsdelivr.net/npm/js-base64@3.2.1/base64.mjs';

// or if you prefer no Base64 namespace
import { encode, decode } from 'https://cdn.jsdelivr.net/npm/js-base64@3.2.1/base64.mjs';
</script>
```
